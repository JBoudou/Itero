...
export class PollComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    console.log(this.breakpointtablet=getComputedStyle(document.body).getPropertyValue('--breakpoint-tablet'));
    console.log(this.breakpointlaptop=getComputedStyle(document.body).getPropertyValue('--breakpoint-laptop'));
  }
